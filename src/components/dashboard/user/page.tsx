...
const UserPageComponent: FC = () => {
  ...
  const openUserModal = (usuario: IStudentData) => {
      ...
      <div className="bg-gradient-to-br from-accent-dark/80 to-[#1a1a1a] rounded-xl border border-accent-dark/30 shadow-xl backdrop-blur-sm overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              <tr className="border-t border-accent-dark/30 hover:bg-accent-dark/20 transition-colors">
                ...
                <td className="py-3 px-4 text-center">
                  <div className="font-oswald text-white text-lg">10</div>
                </td>
                <td className="py-3 px-4 text-center">
                  <span
                    className={`inline-block rounded-full px-3 py-1 text-xs font-montserrat text-white capitalize `}
                  >
                    listo
                  </span>
                </td>
