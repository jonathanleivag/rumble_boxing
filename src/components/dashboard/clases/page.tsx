...
import { ClassFormData, GroupFormData } from "@/type";
...
import { getSchedules } from "@/lib/db/actions/schedules.action";
import { initialSchedule } from "@/lib/redux/features/schedule/schedule.slice";
  ...
  return (
    <div className="space-y-8">
      ...
      <ButtonClassComponent
        totalClasses={classData.reduce((acc, item) => acc + item.duration, 0)}
        countClass={classData.length}
        setIsCreateModalOpen={setIsCreateModalOpen}
        setIsGroupModalOpen={setIsGroupModalOpen}
        countGroup={schedules.length}
      />
      {classData.length > 0 && (
        <div className="mt-10">
          <motion.div
      ...
      {schedules.length > 0 && (
        <div>
          ...
          <SchedulesClassComponent
            setIsCreateModalOpen={setIsGroupModalOpen}
